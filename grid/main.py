...
from models.blockchain import AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY
...
plantA.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
plantB.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
big_factory.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
household_a.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
household_b.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
household_c.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
...
substationB.authorize(AUTHORIZER_ADDRESS, AUTHORIZER_PRIVATE_KEY)
